...
USERNAME = environ.get('USERNAME', "https://telegram.me/Hindi_Movie_Webseries_Anime_Bot")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002045377846'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+c63lBVD2hUlmM2E1')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002151177035'))
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/ccb9db43e62a2e524928e.jpg')
START_IMG = environ.get('START_IMG', 'https://telegra.ph/file/81eef9d6c7a09b0e1425c.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002331290045'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002109745938'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002094129104'))
